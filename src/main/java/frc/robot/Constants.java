...
public final class Constants {
    ...
    public static final int DRIVER_RPM_INCREASE = 11; // bottom left base of controller
    public static final int DRIVER_RPM_DECREASE = 12; // bottom right base of controller
